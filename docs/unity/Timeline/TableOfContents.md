- [About Timeline](index)
  - [Timeline overview](tl_about)
  - [Using the Timeline window](wf_about.md)
    - [Creating a Timeline Asset and Timeline instance](wf_instance)
    - [Recording basic animation with an Infinite clip](wf_rec_anim)
